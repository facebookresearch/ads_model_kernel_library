...
from lp_fa4.cute.utils import (
    copy_bulk_g2s_maybe_elect,
    elem_pointer,
    get_batch_from_cu_tensor,
    smid,
)
from lp_fa4.cute.copy_utils import tiled_copy_2d, atomic_add_fp32x4

from lp_fa4.cute.topk_gather_kv import CpasyncGatherKVManager


from lp_fa4.cute.named_barrier import NamedBarrierBwdSm100_MLA2CTA
...
class FlashAttentionSparseMLABackwardSm100:
    ...
    def load_inner(
        ...
        if const_expr(bulk_copy):
            copy_bulk_g2s_maybe_elect(copy_atom, tXgX, tXsX, mbar_ptr=mbar_ptr)
        else:
