...
from lp_fa4.cute.mask import (
    Sm100FusedMask as FusedMask,
)
from lp_fa4.cute.tile_scheduler import SM100_TMEM_CAPACITY_COLUMNS
from lp_fa4.cute.flash_fwd_sm100 import DescaleTensors, _TUNING_CONFIG
from lp_fa4.cute.utils import ex2_emulation_2
...
class BlackwellFusedMultiHeadAttentionForward:
    ...
    def __call__(
        ...
        assert aux_data is None or aux_data.tensors is None or len(aux_data.tensors) == 0, (
            "SM100 forward with head_dim=256 does not support aux_tensors"
        )
        assert aux_data is None or aux_data.scalars is None or len(aux_data.scalars) == 0, (
