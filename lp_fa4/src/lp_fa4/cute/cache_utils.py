...
from lp_fa4.cute.fa_logging import fa_log
...
def _compute_source_fingerprint() -> str:
    ...
    - Any .py file under lp_fa4/cute is added, removed, renamed, or modified.
...
class JITPersistentCache(JITCache):
    ...
    def _key_to_hash(self, key: CompileKeyType) -> str:
        # The serialized bytes are hashed immediately and never deserialized.
