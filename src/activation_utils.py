...
E8M0_NEUTRAL_SCALE = 127  # Scale = 1.0 in E8M0 format (2^(127-127) = 2^0 = 1.0)
...
@dsl_user_op
def store_u32_shared(ptr: Int64, val: Uint32, *, loc=None, ip=None) -> None:
...
@dsl_user_op
def max_f32(a: float | Float32, b: float | Float32, *, loc=None, ip=None) -> Float32:
...
@dsl_user_op
def step_f32(x: float | Float32, *, loc=None, ip=None) -> Float32:
...
@dsl_user_op
def max3_f32(
    a: float | Float32, b: float | Float32, c: float | Float32, *, loc=None, ip=None
) -> Float32:
...
class Relu:
    ...
    def __init__(
        ...
        self.c_zero = (Float32(0.0), Float32(0.0))
        self.c_one = (Float32(1.0), Float32(1.0))
...
class Gelu:
    def __init__(
        ...
        self.scale_qk = scale_qk
        self.c_half = (Float32(0.5), Float32(0.5))
        self.c_one = (Float32(1.0), Float32(1.0))
        self.c_two = (Float32(2.0), Float32(2.0))
        self.c_three = (Float32(3.0), Float32(3.0))
        self.c_four = (Float32(4.0), Float32(4.0))
        self.c_six = (Float32(6.0), Float32(6.0))
        self.c_alpha = (Float32(0.044715), Float32(0.044715))
        self.c_beta = (Float32(0.7978845608), Float32(0.7978845608))
