...
from ..src.interface import flash_attn_combine, flash_attn_func, flash_attn_varlen_func
...
def test_flash_attn_kvcache(
    ...
    has_rotary_seqlens: bool,
    seqlen_new_eq_seqlen_q: bool,
    causal: bool,
    local: bool,
    new_kv: bool,
    has_learnable_sink: bool,
...
def test_flash_attn_combine(
    num_splits: int, seqlen: int, d: int, dtype: torch.dtype
) -> None:
    device = "cuda"
    # set seed
