...
Setup:
    bash ads_mkl/ops/oss/gdpa/scripts/setup_benchmark_env.sh

Usage:
    conda activate gdpa-bench
    python ads_mkl/ops/oss/gdpa/scripts/benchmark.py bench-fwd
    python ads_mkl/ops/oss/gdpa/scripts/benchmark.py bench-bwd
    python ads_mkl/ops/oss/gdpa/scripts/benchmark.py bench-fwd-bwd
...
from ads_mkl.ops.oss.gdpa.src.interface import (
    flash_attn_varlen_func as cutedsl_gdpa_varlen_func,
    precompute_for_varline_load_balancing,
)
from ads_mkl.ops.oss.gdpa.utils.utils import generate_jagged_data
