...
def get_fp8_dtype(tensor: torch.Tensor, fp8_format: str = "e4m3") -> Optional[object]:
...
class FlashAttnFunc(torch.autograd.Function):
    ...
    @staticmethod
    def backward(ctx, dout, *args) -> Tuple[Optional[torch.Tensor], ...]:
