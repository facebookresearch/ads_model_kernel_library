...
class GeneralizedDotProductAttentionTestCase(unittest.TestCase):
    ...
    @patch(
        "ads_mkl.ops.oss.gdpa.triton.triton_generalized_dot_product_attention.torch.jit.is_tracing"
    )
    @patch(
        "ads_mkl.ops.oss.gdpa.triton.triton_generalized_dot_product_attention.cpu_generalized_dot_product_attention"
    )
    ...
    @patch(
        "ads_mkl.ops.oss.gdpa.triton.triton_generalized_dot_product_attention.torch.jit.is_scripting"
    )
    @patch(
        "ads_mkl.ops.oss.gdpa.triton.triton_generalized_dot_product_attention.torch.jit.is_tracing"
    )
    ...
    @patch(
        "ads_mkl.ops.oss.gdpa.triton.triton_generalized_dot_product_attention.torch.ops.gdpa.generalized_dot_product_attention"
    )
    @patch(
        "ads_mkl.ops.oss.gdpa.triton.triton_generalized_dot_product_attention.torch.jit.is_scripting"
    )
